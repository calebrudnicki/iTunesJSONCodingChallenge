...
//    let position: String!
    ...
    init(name: String, releaseDate: String, purchasePrice: String, rentalPrice: String, summary: String, image: String, rights: String, link: String) {
        self.name = name
    ...
    func toAnyObject() -> AnyObject {
        return ["name": name, "releaseDate": releaseDate, "purchasePrice": purchasePrice, "rentalPrice": rentalPrice, "summary": summary, "image": image, "rights": rights, "link": link] as AnyObject
    }
